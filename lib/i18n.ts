    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "High-converting UGC & e-commerce product ad edits optimized for meta, TikTok & YouTube ads",
        },
        {
          number: "03",
          title: "VIDEO SALES LETTERS (VSL)",
          desc: "Persuasive sales video edits with kinetic text, pattern interrupts, and seamless visual pacing",
        },
        {
          number: "04",
        ...
        },
        {
          ...
          desc: "Engaging long-form YouTube editing with dynamic graphics, B-roll insertion & sound effects",
        },
        {
          number: "06",
        ...
        {
          number: "07",
          title: "PODCASTS & SAAS DEMOS",
          desc: "Multi-cam podcast edits, interview cuts & crisp SaaS product walkthrough videos",
        },
      ],
    },
    portfolio: {
  ...
  fr: {
    ...
    services: {
      ...
      items: [
        ...
        {
          number: "02",
          title: "UGC & PUBLICITÉS PRODUIT",
          desc: "Publicités vidéo UGC et e-commerce à forte conversion optimisées pour TikTok, Meta & YouTube",
        },
        {
          number: "03",
          title: "VIDEO SALES LETTERS (VSL)",
        ...
        {
          number: "04",
          title: "PUBLICITÉS DE MARQUE",
          desc: "Montages cinématographiques avec design sonore, étalonnage et narration haut de gamme",
        },
        {
          number: "05",
          title: "VLOGS YOUTUBE & TALKING HEAD",
          desc: "Montage YouTube captivant avec éléments graphiques, B-roll et effets sonores",
        },
        {
          number: "06",
          title: "DOCUMENTAIRES & ESSAIS VIDÉO",
          desc: "Montages documentaires approfondis avec narration immersive et animation sur mesure",
        },
        {
          number: "07",
          title: "PODCASTS & DÉMOS SAAS",
          desc: "Montage multi-caméras pour podcasts et présentations vidéo fluides de produits SaaS",
        },
      ],
    },
    portfolio: {
